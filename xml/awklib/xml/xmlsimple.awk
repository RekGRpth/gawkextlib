...
#   $0:  Text representation of the current token (reconstructed)
#
...
#   XmlDocCount:  Number of documents in a single XML stream
#
...
#   XMLINDENT:  Indentation step (-1, 0, n)
#
# Internal variables
...
#   _Xml_internal_subset: true inside DOCTTYPE with internal declarations
...
EOI { XmlDocCount++ } # end-of-instance
...
function _Xml_ProvideCHARDATA() {
   ...
   if (XMLTRIM) CHARDATA = _Xml_trim(CHARDATA)
}
