...
static awk_ext_func_t func_table[] = {
	...
	{ "psubscribe",  do_psubscribe, 2 },
	{ "unsubscribe",do_unsubscribe, 2 },
	{ "punsubscribe",do_punsubscribe, 2 },
	...
	{ "brpop",	do_brpop, 4 },
	{ "blpop",	do_blpop, 4 },
	{ "brpoplpush", do_brpoplpush, 4 },
	{ "linsertBefore",do_linsertBefore, 4 },
	{ "linsertAfter",do_linsertAfter, 4 },
	{ "lrem",	do_lrem, 4 },
	{ "ltrim",	do_ltrim, 4 },
	{ "lpushx",	do_lpushx, 3 },
	{ "rpush",	do_rpush, 3 },
	...
	{ "zrem",	do_zrem, 3 },
	{ "zrange",	do_zrange, 5 },
	{ "zrevrange",	do_zrevrange, 5 },
	{ "zunionstore",do_zunionstore, 5 },
	{ "zinterstore",do_zinterstore, 5 },
	{ "zrank",	do_zrank, 3 },
	{ "zrangeWithScores",	do_zrangeWithScores, 5 },
	{ "zrevrangeWithScores",	do_zrevrangeWithScores, 5 },
	{ "zrevrank",	do_zrevrank, 3 },
	{ "zscore",	do_zscore, 3 },
	{ "zincrby",	do_zincrby, 4 },
        { "zlexcount",  do_zlexcount, 4 },
        { "zrangebylex",do_zrangebylex, 5 },
        { "zrangebyscore",do_zrangebyscore, 5 },
        { "zrevrangebyscore",do_zrevrangebyscore, 5 },
        { "zremrangebylex",do_zremrangebylex, 4 },
        { "zremrangebyrank",do_zremrangebyrank, 4 },
        { "zremrangebyscore",do_zremrangebyscore, 4 },
	{ "zscan",	do_zscan, 5 },
	{ "script",	do_script, 4 },
	{ "evalsha",	do_evalsha, 5 },
	{ "evalRedis",	do_evalRedis, 5 },
	{ "multi",	do_multi, 1 },
	{ "exec",	do_exec, 2 },
	{ "watch",	do_watch, 2 },
	{ "unwatch",	do_unwatch, 1 },
