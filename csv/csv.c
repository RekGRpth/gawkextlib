...
static awk_value_t *
do_csvconvert(int nargs, awk_value_t *result)
{
...
//    return make_const_string(record, strlen(record), result);
...
static awk_value_t *
do_csvsplit(int nargs, awk_value_t *result)
{
    awk_value_t csv_record;
    awk_value_t fields;
    char csvcomma;
...
static awk_ext_func_t func_table[] = {
    { "csvconvert", do_csvconvert, 4 },
    { "csvsplit", do_csvsplit, 4 },
};
